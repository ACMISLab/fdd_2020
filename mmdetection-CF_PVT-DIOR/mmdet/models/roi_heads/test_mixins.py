...
class BBoxTestMixin:
    ...
    def aug_test_bboxes(self, feats, img_metas, proposal_list, rcnn_test_cfg):
        ...
        # print('---------test_mixins-aug_bboxes-------------------',aug_bboxes)
        # print('---------test_mixins-aug_scores-------------------',aug_scores)
        # after merging, bboxes will be rescaled to the original image size
        merged_bboxes, merged_scores = merge_aug_bboxes(
            aug_bboxes, aug_scores, img_metas, rcnn_test_cfg)
        # print('---------merged_bboxes-merged_scores-------------------')
        # print('----------merged_bboxes------------------', len(merged_bboxes),len(merged_bboxes[0]),merged_bboxes)
        # print('----------merged_scores------------------', len(merged_scores),len(merged_scores[0]),merged_scores)
