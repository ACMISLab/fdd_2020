...
class CascadeRoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def _bbox_forward_train(self, stage, x, sampling_results, gt_bboxes,
                            gt_labels, img_metas, rcnn_train_cfg):
        """Run forward function and calculate loss for box head in training."""
        #print('-----------------sampling_results.shape--------------',sampling_results['pos_bboxes'],sampling_results['neg_bboxes'])
        sum=0
        proposal_index = []
        ...
        # print('---------------bbox_results_cls_score-----------------',len(bbox_results['cls_score']))
