...
def draw_feature_map(features,save_dir = '/remote-home/fdd/acmis_fdd/mmdetection_lately/feature_map',name = None):
    i=0
    if isinstance(features,torch.Tensor):
        for heat_maps in features:
            ...
            for heatmap in heatmaps:
                ...
                cv2.imwrite(os.path.join(save_dir,name + str(uuid.uuid1())+ str(i) +'.png'), superimposed_img)
        ...
        for featuremap in features:
            ...
            for heatmap in heatmaps:
                ...
                cv2.imwrite(os.path.join(save_dir,save_dir,name +str(uuid.uuid1())+ str(i) +'.png'), superimposed_img)
                i=i+1
